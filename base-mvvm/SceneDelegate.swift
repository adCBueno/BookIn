...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func getRootViewControllerForValidUser() -> UIViewController {
        ...
        tabBarVC.tabBar.tintColor = ColorConstants.headerColor
        
        // Add VCs to TabBarVC
        tabBarVC.viewControllers = [
            createNavController(for: BookListViewController(), title: "", image: UIImage(systemName: "house.fill")!),
            
            createNavController(for: TopBooksViewController(), title: "", image: UIImage(systemName: "character.book.closed.fill")!),
            
            createNavController(for: SearchBooksViewController(), title: "", image: UIImage(systemName: "magnifyingglass")!),
            
            createNavController(for: SettingViewController(), title: "", image: UIImage(systemName: "gearshape.fill")!)
        ]
